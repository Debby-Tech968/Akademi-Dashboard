    ...
    <div className="bg-[#F3F4FF] xl:ml-80 min-h-screen">
      <Wrapper>
        ...
        <div className="sticky  xl:fixed top-0 xl:left-80 xl:right-5 z-20 bg-[#F3F4FF] py-4 xl:pt-8 xl:px-10 flex flex-col lg:flex-row justify-between items-end md:items-end lg:items-center gap-4">
          <h1 className="text-3xl lg:mt-7 xl:mt-0 md:text-4xl font-bold text-[#303972]">
            Add New Teachers
          </h1>
          ...
          <div className="lg:flex hidden items-center gap-6">
            ...
            <div className="bg-white rounded-full p-3">
              <img src={gear} alt="" className="w-6 h-6" />
            </div>
        ...
        <h2 className="mt-12 text-[24px] p-4 bg-[#4D44B5] rounded-t-lg font-bold text-[#FFFFFF]">
          Education
        </h2>
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                type="text"
                placeholder="Lautech"
                className="border border-[#C1BBEB] rounded-lg px-4 py-2 outline-none focus:border-[#4D44B5]"
              />
            </div>
            ...
            {/* <div className="flex flex-col gap-2">
              ...
              <input
                type="email"
                placeholder="student@email.com"
                className="border rounded-lg px-4 py-2 outline-none focus:border-[#4D44B5]"
              />
            </div> */}
            ...
            <div className="flex flex-row gap-15">
              <div className="flex flex-col gap-2 md:col-span-2">
                ...
                <textarea
                  placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam "
                  className="border border-[#C1BBEB] rounded-lg px-4 py-3 outline-none focus:border-[#4D44B5]  lg:w-100 lg:h-40 md:w-81 md:h-40 w-85 h-40"
                />
              </div>
                ...
                <div className="flex items-center gap-3">
                  <div className="flex flex-row gap-8">
                    <div className="flex gap-2">
                      <input
                        type="checkbox"
                        className="w-4 h-4 mt-1 accent-[#4D44B5]"
                      />
